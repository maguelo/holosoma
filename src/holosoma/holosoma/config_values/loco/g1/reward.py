...
# Unified locomotion stage 3 — same as unified but with:
# - base_height penalty (-3.0): torso drops when leaning forward → directly targets forward lean
# - penalty_orientation doubled (-20.0): stronger anti-lean signal at sprint speed
# Warm-start from exp_008 (model_80896.pt). Fixes sprint instability observed in exp_007/008.
g1_29dof_unified3_loco = RewardManagerCfg(
    only_positive_rewards=False,
    terms={
        "tracking_lin_vel": RewardTermCfg(
            func="holosoma.managers.reward.terms.locomotion:tracking_lin_vel",
        ...
        "base_height": RewardTermCfg(
            ...
            weight=-3.0,
            params={"desired_base_height": 0.89},
            tags=["penalty_curriculum"],
        ),
        "penalty_action_rate": RewardTermCfg(
            func="holosoma.managers.reward.terms.locomotion:penalty_action_rate",
...
__all__ = ["g1_29dof_loco", "g1_29dof_loco_fast_sac", "g1_29dof_running_loco", "g1_29dof_strafe_loco", "g1_29dof_sprint2_loco", "g1_29dof_sprint3_loco", "g1_29dof_unified_loco", "g1_29dof_unified3_loco"]
